...
Config.AdminMenu = {
    ...
    PermittedDiscordRoles  = { 11111111111111111111, 22222222222222222222, 33333333333333333333, 44444444444444444444 },
...
Config.Noclip = {
    ...
    PermittedDiscordRoles  = { 11111111111111111111, 22222222222222222222, 33333333333333333333 },
    PermittedGroups = { 'admin' },
...
Config.Permissions = {
    ...
    { 
        ActionType = "TPHERE", -- DO NOT TOUCH
    ...
    { 
        ActionType = 'SETJOB', -- DO NOT TOUCH
        Label = "Set current job and grade",
    ...
    { 
        ActionType = 'SETGROUP', -- DO NOT TOUCH
        Label = "Set group",

        PermittedDiscordRoles  = { 11111111111111111111 },
        PermittedGroups = { 'admin', 'mod'},
    ...
    { 
        ActionType = 'ADDACCOUNT', -- DO NOT TOUCH
    ...
    { 
        ActionType = 'REMOVEACCOUNT', -- DO NOT TOUCH
    ...
    { 
        ActionType = 'ADDITEM', -- DO NOT TOUCH
        Label = "Give the desired item quantity.",
        
        PermittedDiscordRoles  = { 11111111111111111111, 22222222222222222222, 33333333333333333333 },
        PermittedGroups = {  },

        Command = false, -- No command available, TPZ-CORE-INVENTORY Command already contains /additem [id] [item] [quantity]
    
        RequiredParameters = false, -- DO NOT TOUCH
    },

    { 
        ActionType = 'ADDWEAPON', -- DO NOT TOUCH
        Label = "Give the desired weapon.",
        
        PermittedDiscordRoles  = { 11111111111111111111, 22222222222222222222, 33333333333333333333 },
        PermittedGroups = {  },

        Command = false, -- No command available, TPZ-CORE-INVENTORY Command already contains /addweapon [id] [weapon]
    ...
    { 
        ...
        PermittedDiscordRoles  = { 611111111111111111111, 22222222222222222222, 33333333333333333333, 44444444444444444444 },
        PermittedGroups = { 'admin', 'mod' },
